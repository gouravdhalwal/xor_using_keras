...
saved_file_name = "two_input_xor_nn.h5"
...
@app.get("/")
def index():
    return {"message": "A Web App for serving the output of a two input XOR function implemented through neural network using Keras."}
